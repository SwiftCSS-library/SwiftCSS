...
```html
<link rel="stylesheet" href="https://vegacss.drester.top/css/v1.0/VegaCSS-full.css" />
```
...
For a complete guide on all available classes and customization options, check out our [full documentation](https://vegacss.drester.top/docs.html).
...
[**https://vegacss.drester.top/docs.html**](https://vegacss.drester.top/docs.html)
